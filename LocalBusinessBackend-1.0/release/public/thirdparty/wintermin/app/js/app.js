...
(function($, window, document){
  ...
  function adjustLayout() {
    ...
    $('.wrapper > div > section').css('min-height', $(window).height());

    //SK
    var footerHeight = $('.wrapper > div > section > footer').outerHeight();
    var remaining = $(window).height() - footerHeight;

    $('.wrapper > div > section > div.main-content').css('min-height', remaining);
    $('.wrapper > div > section > footer').outerHeight();
  }
