...
angular.module('localBusinessApp')
  .controller('CatalogsListCtrl', ['$scope', '$rootScope', '$http', 'paginator',
    'Catalogs', '$log',
    function($scope, $rootScope, $http, paginator, Catalogs, $log) {
...
angular.module('localBusinessApp')
  .controller('CatalogsItemCtrl', ['$scope', '$log', 'modalDeleteItem', 'Catalogs',
    'Media', '$state',
    function($scope, $log, modalDeleteItem, Catalogs, Media, $state) {
      ...
      $scope.deleteItem = function(record) {
        modalDeleteItem.open(function() {
          ...
          Catalogs
            ...
            .then(function() {
              return Catalogs.delete({
                id: record._id
              });
            })
            .then(function() {
              // reload the list view
              $state.transitionTo('catalogs', {}, {
                reload: true
              });
            })
...
angular.module('localBusinessApp')
  .controller('CatalogsAddFormCtrl', ['$scope', 'Catalogs', 'Media',
    '$log', '$q', '$timeout', '$state', 'ImageUploader',
    function($scope, Catalogs, Media, $log, $q, $timeout, $state,
      ImageUploader) {
...
angular.module('localBusinessApp')
  .controller('CatalogsUpdateFormCtrl', [
    '$scope', '$rootScope', 'Catalogs', '$log', '$q',
    '$stateParams', '$state', 'Media', 'ImageUploader',
    function($scope, $rootScope, Catalogs, $log, $q, $stateParams,
          ...
          */
          ...
          $scope.data.model.$save()
            .then(function onSuccess(response) {
              ...
              $scope.$emit('list_updated');
              // display the updated form
              $state.transitionTo('catalogs.details', {
                id: response._id
              }, {
                reload: true
              });
...
angular.module('localBusinessApp')
  .controller('CatalogsDetailsCtrl', ['$scope', '$stateParams', '$log',
    'Catalogs',
    function($scope, $stateParams, $log, Catalogs) {
