...
angular.module('localBusinessApp')
  .controller('GalleriesListCtrl', ['$scope', '$rootScope', '$http', 'paginator',
    'Galleries', '$log',
    function($scope, $rootScope, $http, paginator, Galleries, $log) {
...
angular.module('localBusinessApp')
  .controller('GalleriesItemCtrl', ['$scope', '$log', 'modalDeleteItem', 'Galleries',
    'Media', '$state',
    function($scope, $log, modalDeleteItem, Galleries, Media, $state) {
...
angular.module('localBusinessApp')
  .controller('GalleriesAddFormCtrl', ['$scope', 'Galleries', 'Media',
    '$log', '$q', '$timeout', '$state', 'ImageUploader',
    function($scope, Galleries, Media, $log, $q, $timeout, $state,
      ImageUploader) {
...
angular.module('localBusinessApp')
  .controller('GalleriesUpdateFormCtrl', [
    '$scope', '$rootScope', 'Galleries', '$log', '$q',
    '$stateParams', '$state', 'Media', 'ImageUploader',
    function($scope, $rootScope, Galleries, $log, $q, $stateParams,
          ...
          */
          ...
          $scope.data.model.$save()
            .then(function onSuccess(response) {
              ...
              $scope.$emit('list_updated');
              // display the updated form
              $state.transitionTo('galleries.details', {
                id: response._id
              }, {
                reload: true
              });
...
angular.module('localBusinessApp')
  .controller('GalleriesDetailsCtrl', ['$scope', '$stateParams', '$log',
    'Galleries',
    function($scope, $stateParams, $log, Galleries) {
