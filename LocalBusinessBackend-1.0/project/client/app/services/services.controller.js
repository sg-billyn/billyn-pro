...
angular.module('localBusinessApp')
  .controller('ServicesListCtrl', ['$scope', '$rootScope', '$http', 'paginator',
    'Services', '$log',
    function($scope, $rootScope, $http, paginator, Services, $log) {
...
angular.module('localBusinessApp')
  .controller('ServicesItemCtrl', ['$scope', '$log', 'modalDeleteItem', 'Services',
    'Media', '$state',
    function($scope, $log, modalDeleteItem, Services, Media, $state) {
...
angular.module('localBusinessApp')
  .controller('ServicesAddFormCtrl', ['$scope', 'Services', 'Media',
    '$log', '$q', '$timeout', '$state', 'ImageUploader',
    function($scope, Services, Media, $log, $q, $timeout, $state,
      ImageUploader) {
...
angular.module('localBusinessApp')
  .controller('ServicesUpdateFormCtrl', [
    '$scope', '$rootScope', 'Services', '$log', '$q',
    '$stateParams', '$state', 'Media', 'ImageUploader',
    function($scope, $rootScope, Services, $log, $q, $stateParams,
          ...
          */
          ...
          $scope.data.model.$save()
            .then(function onSuccess(response) {
              ...
              $scope.$emit('list_updated');
              // display the updated form
              $state.transitionTo('services.details', {
                id: response._id
              }, {
                reload: true
              });
...
angular.module('localBusinessApp')
  .controller('ServicesDetailsCtrl', ['$scope', '$stateParams', '$log',
    'Services',
